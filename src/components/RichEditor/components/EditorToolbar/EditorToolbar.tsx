...
interface BlockTypeButtonsProps {
  editorState: any,
  onToggle: (param1: any, param2: any) => void,
}

const BlockTypeButtons = (props: BlockTypeButtonsProps) => {
...
const InlineStyleButtons = (props: InlineStyleButtonsProps) => {
  const {editorState, onToggle} = props;
...
const EditorToolbar: React.FunctionComponent<EditorToolbarProps> = (props: EditorToolbarProps) => {
